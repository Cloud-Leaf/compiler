...
void Instruction::pushOperand(Operand* o1){
...
void Instruction::pushOperand(Operand* o1,Operand* o2){
    operands.push_back(o1);
...
void Instruction::pushOperand(Operand* o1,Operand* o2,Operand* o3){
    operands.push_back(o1);
    operands.push_back(o2);
